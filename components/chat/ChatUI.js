...
// Versão atualizada com novos ícones para controlar a janela do chat.
...
export const MaximizeIcon = () => <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect></svg>;
...
export const EmojiPicker = ({ onEmojiSelect }) => {
    // ... (código do seletor de emojis permanece o mesmo)
    ...
    return (
        <div className="absolute bottom-24 left-4 bg-white dark:bg-slate-700 p-3 rounded-lg shadow-xl border dark:border-slate-600 w-72">
            {Object.entries(emojisByCategory).map(([category, emojis]) => (
                <div key={category} className="mb-2">
                    <h4 className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase mb-2">{category}</h4>
