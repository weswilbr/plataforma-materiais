...
// Versão com um novo ícone de "Ações" e um ícone de envio aprimorado.
...
// NOVO: Ícone de envio com design aprimorado
...
export const EmojiPicker = ({ onEmojiSelect }) => {
    ...
    return (
        <div className="absolute bottom-24 left-4 bg-white dark:bg-slate-700 p-3 rounded-lg shadow-xl border dark:border-slate-600 w-72 z-20">
