...
// Componente para o gerador de convites com IA.
...
const InviteGenerator = () => {
    ...
    const handleGenerateClick = async () => {
        ...
        const prompt = `Crie um convite de negócio para marketing de rede, em português do Brasil, para a "Equipe de Triunfo". O tom do convite deve ser ${tone}. O nome do convidado é ${guestName}. O perfil do convidado é: "${profileDescription}". O objetivo principal é despertar o interesse para uma apresentação de negócio. Seja persuasivo e claro.`;
